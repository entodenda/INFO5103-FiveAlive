...
}catch(error){console.error("Error Saving A Single Reminder: ", error);}
};
...
export const loadReminders = async() => {
    ...
    }catch(error){console.error("Error loading Reminders: ", error); return null;}
};
...
}catch(error){console.log("Unable to delete all reminders: ", error);}
};